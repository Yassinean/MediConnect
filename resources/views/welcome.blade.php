...
<body class="bg-blue-500">
    <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
        ...
        <ul
            ...
            <li>
                <a class="hidden lg:inline-block py-2 px-6 bg-transparent hover:bg-blue-600 text-sm text-blue-500 font-bold rounded-xl transition duration-200"
    ...
    <div class="max-w-md mx-auto mt-10 bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="flex items-center justify-center mb-4">
            <a href="/login"
                class="bg-gray-900 text-white m-4 py-2 px-4 rounded hover:bg-gray-800 focus:outline-none focus:shadow-outline"
                type="submit">
                Book Appointment
            </a>
        </div>
