                ...
                <div
                    ...
                    <div
                        ...
                        <ul class="hwCTzGuw3Wvg2a388A7l TVHgSaRh3muGJct_epr9">
                            ...
                            <li>
                                <a href="{{ route('speciality.allSpeciality') }}"
        ...
        <div id="main-content"
            ...
            <main>
                <div class="flex justify-between align-center p-5">
                    <h1 class="text-white text-4xl">Section des specialitées </h1>
                    <div>
                ...
                <div id="crud-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form action="{{ route('speciality.ajouterSpeciality') }}" method="POST"
                                class="p-4 md:p-5">
                                @csrf
                        ...
                        <div
                            ...
                            <div>
                                <h3
                                    ...
                                    Specialitées</h3>
                                <span
                                    class="d3C8uAdJKNl1jzfE9ynq _43MO1gcdi2Y0RJW1uHL PeR2JZ9BZHYIH8Ea3F36 XIIs8ZOri3wm8Wnj9N_y">La
                                    liste des spécialitées disponibles</span>
                            </div>
                                                ...
                                                @foreach ($specialities as $s)
                                                    <tr>
                                                        ...
                                                        <td class="_wYiJGbRZyFZeCc8y7Sf BHrWGjM1Iab_fAz0_91H">
                                                            <form
                                                                action="{{ route('speciality.deleteSpeciality', $s->id) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                action="{{ route('speciality.ModiSpeciality', $s->id) }}"
                                                                                method="POST" class="p-4 md:p-5">
                                                                                @csrf
                                                                                @method('PUT')>
                                                                                <h3
                                                                                    class="text-xl font-medium text-gray-900 dark:text-white">
                                                                                    Modifier Spécialité</h3>
                                                                                <div>
                                                                                    <label for="name"
                                                                                        class="text-sm font-medium text-gray-900 block mb-2 dark:text-gray-300">Nouvelle
                                                                                        specialité</label>
                                                                                    <input type="text"
                                                                                        id="name"
                                                                                        name="specialityName"
