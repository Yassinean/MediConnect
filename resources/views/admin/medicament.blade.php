        ...
        <div id="main-content"
            ...
            <main>
                <div class="flex justify-between align-center p-5">
                    <h1 class="text-white text-4xl">Section des médicaments </h1>
                    <div>
                ...
                <div id="crud-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form action="{{ route('medicament.ajouterMedicament') }}" method="POST"
                                class="p-4 md:p-5">
                                @csrf
                                                ...
                                                @foreach ($specialities as $s)
                                                    <tr>
                                                        ...
                                                        <td class="_wYiJGbRZyFZeCc8y7Sf BHrWGjM1Iab_fAz0_91H">
                                                            <form
                                                                action="{{ route('medicament.deleteMedicament', $s->id) }}"
