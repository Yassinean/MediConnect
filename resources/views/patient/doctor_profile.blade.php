    ...
    <div class="p-16">
        <div class="p-8 bg-white shadow mt-24">
            ...
            <div class="mt-20 text-center border-b pb-12">
                <h1 class="text-4xl font-medium text-gray-700">  @dd($medecin->name)
                    <span class="font-light text-gray-500">{{ $medecin->email }}</span>
                </h1>
                <p class="font-light text-gray-600 mt-3"> {{ $medecin->specialiyName }} </p>
